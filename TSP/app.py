...
HtmlFile = open(os.path.join("TSP/maps/exact.html"), 'r', encoding='utf-8')
source_code = HtmlFile.read()
components.html(source_code,height=400)

st.subheader("Ant colony")
HtmlFile = open(os.path.join("TSP/maps/ant.html"), 'r', encoding='utf-8')
source_code = HtmlFile.read()
components.html(source_code,height=400)

st.subheader("Genetic")
HtmlFile = open(os.path.join("TSP/maps/genetic.html"), 'r', encoding='utf-8')
source_code = HtmlFile.read()
components.html(source_code,height=400)